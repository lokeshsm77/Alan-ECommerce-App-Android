...
public class FakeWebServer {
    ...
    public void getAllElectronics() {
        ...
        productlist
                .add(new Product(
                        ...
                        "Samsung 17PMMEC1 17 L Solo Microwave Oven",
       ...
       /* productlist
        ...
        productlist
                .add(new Product(
                        "Eureka Forbes Easy Clean Plus Hand-held",
        ...
        productlist
                .add(new Product(
                        "Croma Wet and Dry Vacuum Cleaner",
                        "Croma Wet and Dry Vacuum Cleaner (CRAV0060, Black)",
                        "Manually cleaning the house is not just tedious but also highly inefficient because there will always remain speck of dust which will not be possible to clean. " +
                                "To manage your daily tasks while multitasking around the house, " +
                                "bring home the all new and super-efficient Croma CRAV0060Wet & Dry Vacuum Cleaner with a powerful motor that makes your job easier. ",
                        "9000",
                        "11",
                        "7990",
                        "0",
        ...
        productMap.put("Vacuum Cleaner", productlist);
    ...
    public void getAllFurnitures() {
        ...
        productlist
                .add(new Product(
                        "Portable Table in Natural Colour",
                        "Portable Table in Natural Colour by ClasiCraf",
                        "With a contemporary design and gorgeous finish, this portable table will be a brilliant addition to modern homes and even offices. " +
                                "The table has a glass table top with a floral print, and a pull-out drawer in the center.",
                        "2599",
                        "15",
                        "3499",
                        "0",
       ...
       /* productlist
        ...
        productlist
                .add(new Product(
                        "Aura Solid Wood Armchair",
                        "Aura Solid Wood Armchair with Brown Upholstery in Provincial Teak Finish by Woodsworth",
                        "Armchairs as the name suggests, comes with arms and a straight upright back. " +
                                "They can either be minimalist as in the bare wooden ones or the upholstered ones." ,
                        "15999",
                        "34",
                        "10499",
                        "0",
        ...
        productlist
                .add(new Product(
                        "Lars Cafe Chair in Black",
                        "Lars Cafe Chair in Black Colour By Durian",
                        "Cafe Chairs are light chairs, easy to move, minimalist in nature and durability. Cafe Chairs are meant to be used for shorter duration and are not " +
                                "so high in comfort.",
                        "9000",
                        "40",
                        "5400",
       ...
       /* productlist
        ...
        productlist
                .add(new Product(
                        "Araki 2 Door Wardrobe",
                        "Araki 2 Door Wardrobe & Dressing Table by Mintwud",
        ...
        productlist
                .add(new Product(
                        "Kosmo Universal Wardrobe",
                        "Kosmo Universal Wardrobe in Natural Wenge Melamine Finish by Spacewood",
                        "These products are made from melamine and membrane finish technology with an Iso approved quality standards. " +
                                "All our products go through stringent quality checks to provide you the best of best at the most durable prices.",
                        "75447",
                        "25",
                        "56699",
                        "0",
        ...
        productMap.put("Wardrobe", productlist);
